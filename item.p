...
ON LEAVE OF Itens.CodProduto 
    DO:
        RUN piValidaProduto (INPUT Itens.CodProduto:SCREEN-VALUE, 
            OUTPUT lValid).
        IF lValid THEN
            DISPLAY Produtos.NomProduto WITH FRAME f-item.
        ELSE
            DISPLAY "Produto nao encontrado" @ Produtos.NomProduto WITH FRAME f-item.
    END.

ON LEAVE OF Itens.NumQuantidade
    DO:
        IF AVAIL Produtos THEN DO: 
            ASSIGN 
                dValTotal = Produtos.ValProduto * INPUT Itens.NumQuantidade.
...
ON CHOOSE OF bt-save 
    DO:
        ...
        IF NOT lValid THEN 
        DO:
            MESSAGE "Produto" INPUT Itens.CodProduto "nao existe!"
        ...
        END.        
        ASSIGN 
            bItens.CodProduto    = INPUT Itens.CodProduto
