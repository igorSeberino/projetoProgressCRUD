...
ON CHOOSE OF bt-addItem 
    DO:
        ...
        DO:
            ...
            ASSIGN 
                bPedidos.ValPedido += Itens.ValTotal.
...
ON CHOOSE OF bt-modItem 
    DO:
        ASSIGN 
            cActionItem = "mod".
        ASSIGN 
            Pedidos.ValPedido -= Itens.ValTotal.
    ...
    DO:
        ...
        DO:
            ...
            DO:
                FIND bPedidos WHERE bPedidos.CodPedido = Pedidos.CodPedido EXCLUSIVE-LOCK.
                ASSIGN 
                    bPedidos.ValPedido -= bItens.ValTotal.
                MESSAGE bPedidos.ValPedido
                    VIEW-AS ALERT-BOX.
                DELETE bItens.
                RUN piOpenQuery.
...
ON CHOOSE OF bt-save 
    DO:
        ...
        IF NOT lValid THEN 
        DO:
            MESSAGE "Cliente" INPUT Pedidos.CodCliente "nao existe!"
        ...
        DO:
            CREATE bPedidos.
            ASSIGN 
                bPedidos.CodPedido = INPUT Pedidos.CodPedido.
        END.
        IF  cAction = "mod" THEN 
        DO:
            FIND FIRST bPedidos
        ...
        ASSIGN 
            bPedidos.CodCliente = INPUT Pedidos.CodCliente
