...
ON CHOOSE OF bt-exp 
    DO:
        ...
        FIND bClientes WHERE bClientes.CodCliente = Clientes.CodCliente NO-LOCK.
    
    // Arquivo CSV
        ASSIGN 
            cArq = SEARCH("Clientes.p") 
    ...
    // Arquivo JSON
        ...
        FIND Clientes WHERE Clientes.CodCliente = bClientes.CodCliente NO-LOCK.
        RUN piMostra.
    END.
